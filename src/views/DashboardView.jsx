  ...
  return (
    <main className="w-full min-h-screen bg-surface pt-16 md:pt-12 px-4 sm:px-6 md:px-margin-desktop py-4 sm:py-gutter-xl">
      <div className="mx-auto w-full max-w-[1440px] space-y-6">
        ...
        <section data-block-id="dashboard-now-hero" className="rounded-2xl border border-primary/15 bg-gradient-to-br from-primary/[0.09] to-surface-container-lowest p-5 shadow-sm">
        ...
        <section className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          <div data-block-id="dashboard-today-tasks" className="space-y-6 lg:col-span-8">
